#!/bin/bash
#SBATCH --job-name=merge-mu-32b-structured
...
srun /workspace-vast/adamk/activation_oracles_dev/.venv/bin/python \
    investigations/model_understanding_prime_rl/lora_tools/merge_sft_adapter.py \
        ...
        --adapter-path /workspace-vast/adamk/activation_oracles_dev/checkpoints_text_sft/mu_qwen3_32b_structured_synth_e1_kl1/final \
        --output-dir /workspace-vast/adamk/prime-rl/outputs/mu_qwen3_32b_structured_synth_e1_kl1_merged
